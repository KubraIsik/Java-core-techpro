...
public class StringManipulations04 {
    public static void main(String[] args) {
        ...
        */
        ...
        int a = 12;
        // heap addresses of non-primitives are stored in stack.
        String s = "Tom";
        /*
        memory kullanimi:
        ...
        String str2 = new String("Merhba");
        String str3 = str1;
        System.out.println(str1 == str2); // check their address
        System.out.println(str1.equals(str2)); // chech their values
        System.out.println(str1 == str3); // they share same address and values
    }
}
